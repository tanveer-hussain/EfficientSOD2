...
class Saliency_feat_encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        conv1_feat_vgg = self.aspp_mhsa1_3_vgg(x1_vgg)
        ...
        conv2_feat_vgg = self.aspp_mhsa2_3_vgg(x2_vgg)
        ...
        conv3_feat = self.conv1_1(torch.cat((self.conv3(x3), conv3_feat,conv3_feat_vgg),1))
        # conv3_feat = self.aspp_mhsa3_2(conv3_feat)
        ...
        conv4_feat = self.conv1_1(torch.cat((self.conv4(x4), conv4_feat,conv4_feat_vgg),1))
